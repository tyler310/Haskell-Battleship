...
guess sock = do
    ...
    let (ans, win) = getResultGuess sock -- replace this with the send guess function, ans should be the bool reply
...
main gb ob hit_boats guesses sock = do
    ...
    sendResultGuess sock (o_hit, lose)
